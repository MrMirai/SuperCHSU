...
public class ScheduleDB : DbContext
{
    ...
    public string path = @"DataBase/schedule.db";
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseSqlite($"DataSource = {path}");
}